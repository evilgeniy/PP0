    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(players.size == 0)
        {
            ...
            val dataList = myDbManager.readDbData()
             if(dataList.isEmpty())
            {
                myDbManager.insert("Bovan","Player1","10:10:10")
                dataList.add(Player("Bovan","Player1","10:10:10"))
                myDbManager.insert("Kern","Player2","00:10:10")
                dataList.add(Player("Kern","Player2","00:10:10"))
                myDbManager.insert("Baine","Player3","00:00:10")
                dataList.add(Player("Baine","Player3","00:00:10"))
            }
